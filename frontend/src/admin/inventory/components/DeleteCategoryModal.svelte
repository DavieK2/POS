  ...
  >
    ...
    >
      <div class="px-6 py-4 border-b border-neutral-200">
        <h2 id="delete-category-title" class="text-lg font-semibold text-black">Confirm Delete</h2>
      </div>
      ...
      <div class="p-6">
        <div class="flex items-start gap-4 mb-6">
          ...
          <div>
            <p class="text-neutral-700">Are you sure you want to delete the category</p>
            <p class="font-semibold text-black">"{currentCategory.categoryName}"?</p>
